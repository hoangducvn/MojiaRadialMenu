...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('MojiaRadialMenu:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('MojiaRadialMenu:client:toggleBlips', function()
...
RegisterNetEvent('MojiaRadialMenu:client:toggleNames', function()
...
RegisterNetEvent('MojiaRadialMenu:client:Show', function(players)
